...
void GUI::PrintMessage(Queue<string>* msgs) const
{
	ClearStatusBar();	//First clear the status bar
	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	...
	msgs->dequeue(msg);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight-10), msg);
																		  
	msgs->dequeue(msg);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight -40), msg);
																		  
	msgs->dequeue(msg);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight -70), msg);
																		  
	msgs->dequeue(msg);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight -100), msg);
...
void GUI::UpdateStatusBar(string txt)
{

	PrintMessage(txt);
}

void GUI::UpdateStatusBar(Queue<string>* msgs)
{
	PrintMessage(msgs);
}
...
void GUI::UpdateInterface(string txt)
{
	ClearDrawingArea();
	UpdateStatusBar(txt);
	DrawCastleArea();
...
void GUI::UpdateInterface(Queue<string>* msgs)
{

	ClearDrawingArea();
	UpdateStatusBar(msgs);
	DrawCastleArea();
	DrawAllItems();
}
